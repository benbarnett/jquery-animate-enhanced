...
@benpbarnett
*/
(function(d,C,D){function J(a,b,l,c){if("d"!=l&&E(a)){var g=K.exec(b),e="auto"===a.css(l)?0:a.css(l),e="string"==typeof e?z(e):e;"string"==typeof b&&z(b);c=!0===c?0:e;var f=a.is(":hidden"),n=a.translation();"left"==l&&(c=parseInt(e,10)+n.x);"right"==l&&(c=parseInt(e,10)+n.x);"top"==l&&(c=parseInt(e,10)+n.y);"bottom"==l&&(c=parseInt(e,10)+n.y);if(g||"show"!=b)g||"hide"!=b||(c=0);else if(c=1,f)elem=a[0],elem.style&&(display=elem.style.display,d._data(elem,"olddisplay")||"none"!==display||(display=elem.style.display=
""),""===display&&"none"===d.css(elem,"display")&&d._data(elem,"olddisplay",L(elem.context.tagName)),""===display||"none"===display)&&(elem.style.display=d._data(elem,"olddisplay")||""),a.css("opacity",0);return g?(a=parseFloat(g[2]),g[1]&&(a=("-="===g[1]?-1:1)*a+parseInt(c,10)),"%"==g[3]&&(a+="%"),a):c}}function M(a,b,l,c,g,e,f,n){var m=a.data(r),m=m&&!q(m)?m:d.extend(!0,{},N),s=g;if(-1<d.inArray(b,A)){var k=m.meta,p=z(a.css(b))||0,t=b+"_o",s=g-p;k[b]=s;k[t]="auto"==a.css(b)?0+s:p+s||0;m.meta=k;
f&&0===s&&(s=0-k[t],k[b]=s,k[t]=0)}return a.data(r,O(a,m,b,l,c,s,e,f,n))}function O(a,b,d,c,g,e,f,n,m){var s=!1;f=!0===f&&!0===n;b=b||{};b.original||(b.original={},s=!0);b.properties=b.properties||{};b.secondary=b.secondary||{};n=b.meta;for(var r=b.original,p=b.properties,t=b.secondary,h=k.length-1;0<=h;h--){var u=k[h]+"transition-property",v=k[h]+"transition-duration",q=k[h]+"transition-timing-function";d=f?k[h]+"transform":d;s&&(r[u]=a.css(u)||"",r[v]=a.css(v)||"",r[q]=a.css(q)||"");var P=t,Q=d,
w;if(f){w=n.left;var F=n.top;w=!0===m||!0===B&&!1!==m&&G?"translate3d("+w+"px, "+F+"px, 0)":"translate("+w+"px,"+F+"px)"}else w=e;P[Q]=w;p[u]=(p[u]?p[u]+",":"")+d;p[v]=(p[v]?p[v]+",":"")+c+"ms";p[q]=(p[q]?p[q]+",":"")+g}return b}function R(a){for(var b in a)if(!("width"!=b&&"height"!=b||"show"!=a[b]&&"hide"!=a[b]&&"toggle"!=a[b]))return!0;return!1}function q(a){for(var b in a)return!1;return!0}function L(a){a=a.toUpperCase();var b={LI:"list-item",TR:"table-row",TD:"table-cell",TH:"table-cell",CAPTION:"table-caption",
...
U)){var u=-1<d.inArray(h,A),v=J(b,a[h],h,u&&!0!==a.avoidTransforms);S(h,v,b)?M(b,h,c.duration,p,v,u&&!0!==a.avoidTransforms,g,a.useTranslate3d):t[h]=a[h]}b.unbind("webkitTransitionEnd oTransitionEnd transitionend");h=b.data(r);if(!h||q(h)||q(h.secondary))c.queue=!1;else{f++;b.css(h.properties);var x=h.secondary;setTimeout(function(){b.bind("webkitTransitionEnd oTransitionEnd transitionend",l).css(x)})}q(t)||(f++,C.apply(b,[t,{duration:c.duration,easing:d.easing[c.easing]?c.easing:d.easing.swing?"swing":
"linear",complete:n,queue:c.queue}]));return!0})};d.fn.animate.defaults={};d.fn.stop=function(a,b,l){if(!I)return D.apply(this,[a,b]);a&&this.queue([]);this.each(function(){var c=d(this),g=c.data(r);if(g&&!q(g)){var e,f={};if(b){if(f=g.secondary,!l&&void 0!==typeof g.meta.left_o||void 0!==typeof g.meta.top_o)for(f.left=void 0!==typeof g.meta.left_o?g.meta.left_o:"auto",f.top=void 0!==typeof g.meta.top_o?g.meta.top_o:"auto",e=k.length-1;0<=e;e--)f[k[e]+"transform"]=""}else if(!q(g.secondary)){var n=
window.getComputedStyle(c[0],null);if(n)for(var m in g.secondary)if(g.secondary.hasOwnProperty(m)&&(m=m.replace(V,"-$1").toLowerCase(),f[m]=n.getPropertyValue(m),!l&&/matrix/i.test(f[m])))for(e=f[m].replace(/^matrix\(/i,"").split(/, |\)$/g),f.left=parseFloat(e[4])+parseFloat(c.css("left"))+"px"||"auto",f.top=parseFloat(e[5])+parseFloat(c.css("top"))+"px"||"auto",e=k.length-1;0<=e;e--)f[k[e]+"transform"]=""}c.unbind("webkitTransitionEnd oTransitionEnd transitionend");c.css(g.original).css(f).data(r,
