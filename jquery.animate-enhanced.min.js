...
b]=d===true?jQuery.fn.getTranslation(a.meta.left,a.meta.top,l):c}return a};jQuery.fn.animate=function(a,b,i,j){if(!t||jQuery.isEmptyObject(a))return u.apply(this,arguments);d=0;b=typeof b==="undefined"?"_default":b;if(typeof jQuery.fx.speeds[b]!=="undefined")b=jQuery.fx.speeds[b];var c=b&&typeof b==="object"?b:{complete:j||!j&&i||jQuery.isFunction(b)&&b,duration:b,easing:j&&i||i&&!jQuery.isFunction(i)&&i},d=0,l=function(){d--;if(d<=0)if(typeof c.complete==="function")return c.complete.call()},f=function(){for(var g=
{},e=h.length-1;e>=0;e--){g[h[e]+"transition-property"]="none";g[h[e]+"transition-duration"]="";g[h[e]+"transition-timing-function"]=""}if(!a.leaveTransforms===true){e=q(this);var k=e.data("cssEnhanced")||{},s={"-webkit-transform":"","-moz-transform":"","-o-transform":"",transform:""};if(typeof k.meta!=="undefined"){s.left=k.meta.left_o+"px";s.top=k.meta.top_o+"px"}e.unbind(r).css(g).css(s).data("translateX",0).data("translateY",0).data("cssEnhanced",null)}l()},v={bounce:"cubic-bezier(0.0, 0.35, .5, 1.3)",
linear:"linear",swing:"ease-in-out",easeInOutQuint:"cubic-bezier(0.5, 0, 0, 0.8)"},n=null,o="";o=c.easing||"swing";o=v[o]?v[o]:o;for(p in a)jQuery.inArray(p,y)===-1&&this.each(function(){var g=q(this),e=jQuery.fn.interpretValue(g,a[p],p,(p=="left"||p=="top")&&a.avoidTransforms!==true?true:false);if(jQuery.inArray(p,x)>-1&&g.css(p).replace(/px/g,"")!==e)jQuery.fn.applyCSSTransition(g,p,c.duration,o,(p=="left"||p=="top")&&a.avoidTransforms===true?e+"px":e,(p=="left"||p=="top")&&a.avoidTransforms!==
true?true:false,a.useTranslate3d===true?true:false);else{n=!n?{}:n;n[p]=a[p]}});this.each(function(){for(var g=q(this),e=g.data("cssEnhanced")||{},k=h.length-1;k>=0;k--)if(typeof e[h[k]+"transition-property"]!=="undefined")e[h[k]+"transition-property"]=e[h[k]+"transition-property"].substr(2);g.data("cssEnhanced",e)});if(n){d++;u.apply(this,[n,c.duration,c.easing,l])}this.each(function(){var g=q(this).unbind(r);if(!jQuery.isEmptyObject(g.data("cssEnhanced")))if(!jQuery.isEmptyObject(g.data("cssEnhanced").secondary)){d++;
var e=g.data("cssEnhanced").secondary||{};g.css(g.data("cssEnhanced"));setTimeout(function(){g.bind(r,f).css(e)})}});return this}})(jQuery);