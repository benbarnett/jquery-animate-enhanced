...
e);a[f[d]+"transition-duration"]=j+"ms";a[f[d]+"transition-timing-function"]=h;a.secondary[b===true?f[d]+"transform":e]=b===true?k===true&&G?"translate3d("+a.meta.left+"px,"+a.meta.top+"px,0)":"translate("+a.meta.left+"px,"+a.meta.top+"px)":i}return a}function q(a){for(var e in a)return false;return true}function r(a){return parseFloat(a.replace(/px/i,""))}var H=["top","left","opacity","height","width"],f=["","-webkit-","-moz-","-o-"],I=["avoidTransforms","useTranslate3d","leaveTransforms"],C=/^([+-]=)?([\d+-.]+)(.*)$/,
